<template>
  <div class="movie_body">
    <ul>
      <li>
            <div class="pic_show"><img src="/img/img1.jpg" /></div>
            <div class="info_list">
                <h2>无名之辈</h2>
                <p>观众<span class="grade">9.2</span></p>
                <p>主演: 陈建斌,任素汐,潘斌龙</p>
                <p>今天60家影院放映666场</p>
            </div>
      ...
      <li>
            <div class="pic_show"><img src="/img/img2.jpg"></div>
            <div class="info_list">
                <h2>毒液: 致命守护者</h2>
                <p>观众评<span class="grade">9.3</span>
                </p>
      ...
      <li>
            <div class="pic_show"><img src="/img/img1.jpg" alt /></div>
            <div class="info_list">
                <h2>无名之辈</h2>
